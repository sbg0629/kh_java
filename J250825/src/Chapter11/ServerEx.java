...
public static void main(String[] args) {
	...
	try {
		listener = new ServerSocket(9999);//서버소캣객체 생성
		...
		while (true) {
			...
			if(inputMessage.equals("bye")) {//클라이언트의 메시지가 bye 일 때
				System.out.println("클라이언트에서 bye로 연결을 종료 했습니다.");
				break;
			}
